...
import com.motion.alarm.AlarmPreference.Key;
import com.motion.pi.R;

public class AlarmPreferencesActivity extends CustomActionBar implements
							...
							new OnMultiChoiceClickListener() {
								...
								public void onClick(
									...
									if (isChecked) {
										...
										// Only remove the day if there are more
										// than 1
										// selected
										if (alarm.getDays().length > 1) {
											alarm.removeDay(thisDay);
										} else {
											// If the last day was unchecked,
											// re-check
											// it
											((AlertDialog) dialog)
													.getListView()
	...
	// getMathAlarm().getTimeUntilNextAlarmMessage(), Toast.LENGTH_LONG).show();
	// finish();
	// break;
